...
export function Sidebar() {
  ...
  // Kept generic (role-filtered) on purpose: this app has a single PLATFORM_ADMIN
  // role today, but the mechanism stays ready for stage 2 without rework.
